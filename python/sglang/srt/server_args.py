        ...
        if self.speculative_algorithm in ("EAGLE", "EAGLE3", "STANDALONE"):
            ...
            if (
                ...
                if (
                    ...
                    logger.warning("WARNING: Running EAGLE beta spec overlap with topk > 1 and page_size > 1 on triton backend. This combination is experimental and NOT officially supported. May produce incorrect results or crash.")
                else:
                    raise ValueError(
